<i18n>
{
    "fr": {
        ...
        "aboutMe": {
            ...
            "about": "Je suis un passionné de l’informatique. J’ai étudié l’administration des Systèmes et Réseaux Informatiques."
        },
        "Nom :": "Nom :",
        ...
        "skill": {
            ...
            "virtualisation": "Virtualisation et Conteneur",
            "symfony": "Symfony",
            "vuejs": "Vue.js",
            "nodejs": "NodeJS",
            "qt": "Qt",
    ...
    "en": {
        ...
        "skill": {
            ...
            "windowsServer": "Windows Server",
            "linuxServer": "Linux Server",
            "virtualisation": "Virtualization & Container",
            "symfony": "Symfony",
            "vuejs": "Vue.js",
            "nodejs": "NodeJS",
            "qt": "Qt",
            ...
            <div class="double-items">
                <div class="row align-center">
                    <div class="col-lg-6 info">
                        ...
                        <h2>{{ t("Salut") }} <img src="assets/img/shape/4.png" alt="Icon"> {{ t("C'est") }} <span>Picasso</span>
                        </h2>
                ...
                <div class="row align-center">
                    <div class="col-lg-5">
                        <div class="left-info">
                            ...
                            <h2 class="title">{{ t("Regardez mon portfolio et") }} <br> {{ t("donnez moi votre avis") }}
                            </h2>
                ...
                <div class="row">
                    <div class="col-xl-10 offset-xl-1">
                        ...
                        <div id="nav-tab" class="nav nav-tabs text-center resume-tab-navs" role="tablist">
                            ...
                            <button id="nav-id-1" class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab1"
                                    type="button" role="tab" aria-controls="tab1" aria-selected="true">
                                {{ t("Biographie") }} <strong>01</strong>
                            </button>
                            <button id="nav-id-2" class="nav-link" data-bs-toggle="tab" data-bs-target="#tab2"
                                    type="button" role="tab" aria-controls="tab2" aria-selected="false">
                                {{ t("Compétences") }} <strong>02</strong>
                            </button>
                            <button id="nav-id-3" class="nav-link" data-bs-toggle="tab" data-bs-target="#tab3"
                                    type="button" role="tab" aria-controls="tab3" aria-selected="false">
                                {{ t("Expériences") }} <strong>03</strong>
                            </button>
                            <button id="nav-id-4" class="nav-link" data-bs-toggle="tab" data-bs-target="#tab4"
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="education-table">
                                            <li v-for="education in educations" :key="education.id">
                                                <h4>{{ getTranslation(unref(education), locale)?.degree }}</h4>
                                                <h5>{{ getTranslation(unref(education), locale)?.school }}</h5>
                                                <span>{{ formatPeriod(education?.startAt, education?.endAt) }}</span>
                                                <p>
                                                    {{ getTranslation(unref(education), locale)?.description }}
                                                </p>
                                            </li>
                                        </ul>
                                    </div>
              ...
              <div class="brand5col swiper">
                <div class="swiper-wrapper align-center">
                  <div class="swiper-slide">
                    <img src="/assets/img/brand/kritek.png" alt="Kritek">
                  </div>
                  <div class="swiper-slide">
                    <img src="/assets/img/brand/wimtec.png" alt="Wimtec">
                  </div>
                  <div class="swiper-slide">
                    <img src="/assets/img/brand/monica-finance.png" alt="Monica Finance">
                  </div>
                  <div class="swiper-slide">
                    <img src="/assets/img/brand/alinkka.png" alt="Alinkka">
                  </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="work-available">
                        ...
                        <h2 class="title">{{ t("Je suis") }} <strong>{{ t("disponible") }}</strong> {{ t("pour") }} <br>
                            {{ t("du Freelance") }}</h2>
                        <a class="btn btn-md circle btn-theme smooth-menu"
                           href="#contact">{{ t("Embauchez moi maintenant") }}</a>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="form-group">
                                                <Field v-slot="{ field, errors }" name="name" rules="required">
                                                    <input
                                                        ...
                                                        :class="{'input-error': errors[0] }" class="form-control"
...
import {configure, defineRule, Field, Form as VeeForm} from "vee-validate";
...
const scrollToElement=() => {
  ...
  gotoHere.scrollIntoView({ behavior: 'smooth' });
}
  ...
  this.hash('#' + section.id);
}
const initialize=()=> {
  this.hoverDropdown();
  this.navbarS<crollspy();
