  ...
  <div id="blog" class="blog-style-one-area blog-area default-padding-top bottom-less">
    ...
    <div class="container">
      <div class="row">
        ...
        <!-- Single item -->
        <div class="blog-style-one mb-30 col-lg-4 col-md-6" v-for="item in data" :key="item.id">
          <div class="item">
            <div class="thumb">
              <a href="#" data-toggle="modal" data-target="#blogSingleModal"><img src="/assets/img/800x600.png" alt="Thumb"></a>
            </div>
            <div class="info">
              <h4>
                <a href="#" data-toggle="modal" data-target="#blogSingleModal">Discovery earnestly public commanded mentions.</a>
              </h4>
              <div class="meta">
                <ul>
                  <li>
        ...
        <div class="blog-style-one mb-30 col-lg-4 col-md-6">
          <div class="item">
            ...
            <div class="info">
              <h4>
                <a href="#" data-toggle="modal" data-target="#blogSingleModal">Considered imprudence of he friendship boisterous.</a>
              </h4>
              <div class="meta">
                <ul>
                  <li>
        ...
        <div class="blog-style-one mb-30 col-lg-4 col-md-6">
          <div class="item">
            ...
            <div class="info">
              <h4>
                <a href="#" data-toggle="modal" data-target="#blogSingleModal">Overcame breeding or my concerns removing desirous.</a>
              </h4>
              <div class="meta">
                <ul>
                  <li>
...
defineProps<{
  data: any
   ...
   const truncate=(chaine:string, offset:number, length:number|undefined)=> {
