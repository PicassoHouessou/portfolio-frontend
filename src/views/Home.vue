...
<i18n>
{
    ...
    "en": {
        ...
        "contact": {
            "title": "I am <span>Available</span> in freelance",
...
<template>
    <div>
        ...
        <section class="hero-wrap js-fullheight" id="home-section">
            ...
            <div class="mouse">
                <a class="mouse-icon" href="#resume-section">
                ...
                <div class="row d-flex no-gutters">
                    <div class="col-md-6 col-lg-6 d-flex">
                        <div class="img-about img d-flex align-items-stretch">
                            <div class="overlay"></div>
                            <div class="img d-flex align-self-stretch align-items-center photo-picasso"
                                 style="background-image:url('/assets/images/picasso/home-about.png'); background-size: contain;">
                            </div>
                            <!--<img src="./../assets/images/picasso/home-about.png" alt="ffff"> -->
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm ftco-animate">
                        <a class="partner" href="#"><img alt="Colorlib Template" class="img-fluid"
                                                         src="../assets/images/partner-1.png"></a>
                    </div>
                    <div class="col-sm ftco-animate">
                        <a class="partner" href="#"><img alt="Colorlib Template" class="img-fluid"
                                                         src="../assets/images/partner-2.png"></a>
                    </div>
                    <div class="col-sm ftco-animate">
                        <a class="partner" href="#"><img alt="Colorlib Template" class="img-fluid"
                                                         src="../assets/images/partner-3.png"></a>
                    </div>
                    <div class="col-sm ftco-animate">
                        <a class="partner" href="#"><img alt="Colorlib Template" class="img-fluid"
                                                         src="../assets/images/partner-4.png"></a>
                    </div>
                    <div class="col-sm ftco-animate">
                        <a class="partner" href="#"><img alt="Colorlib Template" class="img-fluid"
                                                         src="../assets/images/partner-5.png"></a>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="container-fluid px-md-0">
                                <div class="row no-gutters justify-content-center pb-5">
                                    <div class="col-md-12 heading-section text-center ftco-animate">
                                        ...
                                        <p>Quelques réalisations de Picasso</p>
                                    </div>
                                </div>
                                <div class="row no-gutters">
                                    <div class="col-md-4">
